...
def draw_shape(shape):
    ...
    tess.pendown()
    if shape == "heart":
        tess.color(heart_pen_color, heart_fill_color)
        tess.pensize(3)
    tess.begin_fill()
    if shape == "heart":
        tess.left(45)
    ...
    if shape == "heart":
        tess.goto(0, 50)
        tess.color(heart_write_color)
        tess.write("N.S. + A.S.", align="center", font=("Calibri", 30, "normal"))
    tess.color(pen_color, fill_color)
    tess.pensize(2)
...
def correct_position(shape):
    ...
    if shape == "triangle":
        ...
        tess.goto(0, -(math.sqrt(200**2 + 100**2))/2)
    else:
...
pen_color = "gold"
fill_color = "ivory"
heart_pen_color = "gold"
heart_fill_color = "pink"
heart_write_color = "ivory"
...
# list definitions for box bounds and shapes
